...
namespace buoi9{
    class nhanvien{
        ...
        public void xuat(){
            Console.WriteLine("{0,-12}{1,-25}{2,-10}{3,-20}{4,-10}{5,-15}", manv,hoten,hsl, phongban,snlv, luong());
        }
        ...
        class canbo:nhanvien{
            ...
            public void nhap(){
                base.nhap();
                Console.WriteLine("Nhap so chuc vu: ");
            ...
            public new void xuat(){
                Console.WriteLine("{0,-12}{1,-25}{2,-10}{3,-20}{4,-10}{5,-15}{6,-10}{7,-10}",Manv,Hoten, Hsl, Phongban,Snlv,luong(),chucvu,hscv);
            }
        }
